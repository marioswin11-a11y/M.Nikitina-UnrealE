...
AUE_NEW_NikitinaMCharacter::AUE_NEW_NikitinaMCharacter()
{
...
void AUE_NEW_NikitinaMCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUE_NEW_NikitinaMCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUE_NEW_NikitinaMCharacter::Move);
...
void AUE_NEW_NikitinaMCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE_NEW_NikitinaMCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
